...
const BookForm = (props) => {
    ...
    const { bookname, price, quantity } = book;
        ...
        <div className="main-form">
            ...
            <Form onSubmit={handleOnSubmit}>
                ...
                <Form.Group controlId="price">
                    ...
                    <Form.Control className="input-control" type="text" name="price" value={price} placeholder="Enter the price of book" onChange={handleInputChange} />
                </Form.Group>
